...
More recently, utilizing high-resolution plasma measurements from ARTEMIS and MMS missions, @artemyevKineticNatureSolar2019 showed that discontinuities have  kinetic characteristics for both tangential and rotational discontinuities: (1) Jumps in the tangential velocity component are well correlated with jumps in the Alfven speed, and (2) Electron density and temperature vary significantly across these discontinuities. These discoveries revealed the importance of ion and electron kinetics to discontinuity structure.
