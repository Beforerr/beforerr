...
\subsubsection{Interactions of Waves with Radiation Belt Electrons}\label{interactions-of-waves-with-radiation-belt-electrons}
...
\subsubsection{Origin and Characteristics of Waves}\label{origin-and-characteristics-of-waves}
...
\subsubsection{Role of EMIC Waves in Space Weather}\label{role-of-emic-waves-in-space-weather}
...
\subsubsection{Gaps in Current Understanding}\label{gaps-in-current-understanding}
