...
Beyond classical diffusion, observations of SEP events and near interplanetary shocks often reveal anomalous transport behavior [@zimbardoSuperdiffusiveSubdiffusiveTransport2006], characterized by subdiffusive or superdiffusive scaling of particle displacement with time [@zimbardoSuperdiffusiveTransportLaboratory2015]. These deviations from normal diffusion are attributed to the intermittent and structured nature of solar wind turbulence, and are better described using generalized frameworks such as fractional diffusion models [@del-castillo-negreteNondiffusiveTransportPlasma2005] or Lévy statistics [@zaburdaevLevyWalks2015].
