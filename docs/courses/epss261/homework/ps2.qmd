...
tha_fgs_gse = load_dataset(THA_L2_FGM, tspan) |> DimArray

# Filter data
fmin = 1 / 180u"s"
fmax = 1 / 15u"s"
# Wmd_all_ts = tsmooth2(Wmd_all_ts, 61) .- tsmooth2(Wmd_all_ts, 5)
# Wmd_all_ts = Wmd_all_ts .- tsmooth2(Wmd_all_ts, 5)
# Wmd_all_ts = Wmd_all_ts[fmin.<f.<fmax]
```
